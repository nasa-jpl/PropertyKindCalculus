...
def Dimension.MechanicallyReducible (d : Dimension LTMCTDimensionBase) : Prop :=
...
theorem one_mechanicallyReducible : Dimension.MechanicallyReducible (1 : Dimension LTMCTDimensionBase) :=
...
structure ScaleSpanningUnit where
  ...
  reducesTo : Dimension LTMCTDimensionBase
