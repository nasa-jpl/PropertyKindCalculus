...
lean_lib «Uncertainty» where
  ...
  globs := #[
    ...
    .one `PropertyKindCalculus.Uncertainty.BoundaryBudget,
...
lean_lib «UncertaintyRigor» where
  ...
  globs := #[
    ...
    .one `PropertyKindCalculus.Uncertainty.Adequacy.MeanBound,
    .one `PropertyKindCalculus.Uncertainty.Adequacy.RefinementBridge,
