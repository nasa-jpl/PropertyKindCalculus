...
private def suffixName (nm : Name) (k : Nat) : String :=
...
private def d2Names (kg : KindGraph) : Array String := Id.run do
...
an underscore. -/
private def d2Id (nm : String) : String :=
...
private def d2Node (nm : String) : String :=
...
private def compId (names : Array String) (cl : Array Nat) : String :=
