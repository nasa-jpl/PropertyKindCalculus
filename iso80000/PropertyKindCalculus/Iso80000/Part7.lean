...
structure CataloguedKind where
  ...
  ref : StandardRef
  /-- The item designation as printed, e.g. "7-6.1". -/
  item : String
  /-- The principal quantity symbol, e.g. "L_e". -/
  symbol : String
  /-- The coherent SI unit symbol, e.g. "W/(sr·m²)" (a citation locator). -/
  coherentUnit : String
  /-- The dimensioned kind itself. -/
  qk : DimensionedKind

/-- The standard citation for a catalogued kind, e.g.
`ISO 80000-7, Second edition, 2019-08 item 7-6.1`. -/
