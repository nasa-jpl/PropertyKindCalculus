...
structure CataloguedKind where
  ...
  ref : StandardRef
  /-- The item designation as printed, e.g. "4-9.1". -/
  item : String
  /-- The principal quantity symbol, e.g. "F". -/
  symbol : String
  /-- The coherent SI unit symbol, e.g. "N" (a citation locator). -/
  coherentUnit : String
  /-- The dimensioned kind itself. -/
  qk : DimensionedKind

/-- The standard citation for a catalogued kind, e.g.
`ISO 80000-4, Second edition, 2019-08 item 4-9.1`. -/
