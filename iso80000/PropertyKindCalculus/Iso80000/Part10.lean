...
structure CataloguedKind where
  ...
  ref : StandardRef
  /-- The item designation as printed, e.g. "10-81.1". -/
  item : String
  /-- The principal quantity symbol, e.g. "D". -/
  symbol : String
  /-- The coherent SI unit symbol, e.g. "Gy" (a citation locator). -/
  coherentUnit : String
  /-- The dimensioned kind itself. -/
  qk : DimensionedKind

/-- The standard citation for a catalogued kind, e.g.
`ISO 80000-10, Second edition, 2019-08 item 10-81.1`. -/
