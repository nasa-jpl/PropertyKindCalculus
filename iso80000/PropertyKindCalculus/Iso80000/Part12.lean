...
structure CataloguedKind where
  ...
  ref : StandardRef
  /-- The item designation as printed, e.g. "12-27.1". -/
  item : String
  /-- The principal quantity symbol, e.g. "E_F". -/
  symbol : String
  /-- The coherent SI unit symbol, e.g. "J" (a citation locator). -/
  coherentUnit : String
  /-- The dimensioned kind itself. -/
  qk : DimensionedKind

/-- The standard citation for a catalogued kind, e.g.
`ISO 80000-12, Second edition, 2019-08 item 12-27.1`. -/
