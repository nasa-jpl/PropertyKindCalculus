...
PhysLib has no AC or RF physics; the annex is that capability in ladder form
(`PLAN.md`, Exhibit E problem 5 promoted): the catalogue's own RF/AC vocabulary at
